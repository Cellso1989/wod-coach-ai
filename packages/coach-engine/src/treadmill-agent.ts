...
const LEVEL_CONFIGS: Record<number, LevelConfig> = {
  ...
  3: {
    ...
    warmupSpeedRange: WARMUP_COOLDOWN_SPEED,
    cycle: [
      { minutes: 1, speedRange: "8-9", effort: "moderado" },
  ...
  4: {
    ...
    warmupSpeedRange: WARMUP_COOLDOWN_SPEED,
    cycle: [
      { minutes: 1, speedRange: "9-10", effort: "moderado" },
      { minutes: 2, speedRange: "11-13", effort: "moderado_alto" },
      { minutes: 1, speedRange: "14-16", effort: "forte" },
    ],
    cooldownMinutes: 1,
    cooldownSpeedRange: WARMUP_COOLDOWN_SPEED,
  },
  5: {
    ...
    cycle: [
      { minutes: 1, speedRange: "9-10", effort: "moderado" },
      { minutes: 1, speedRange: "11-13", effort: "moderado_alto" },
      { minutes: 1, speedRange: "14-16", effort: "forte" },
      { minutes: 1, speedRange: "17-18", effort: "maximo" },
    ],
    cooldownMinutes: 1,
    cooldownSpeedRange: WARMUP_COOLDOWN_SPEED,
  },
